...
from bedrock_agentcore._utils.snake_case import accept_snake_case_kwargs, deprecated_alias
    ...
    def list_events(
        ...
        **kwargs: Any,
        ...
        Example:
            ...
            ```
        """
        resolved, kwargs = deprecated_alias(kwargs, "eventMetadata", "event_metadata")
        if resolved is not None and event_metadata is None:
            event_metadata = resolved
        if kwargs:
